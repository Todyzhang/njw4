define(['app','angular', 'css!/src/css/main'], function (app,angular) {
  'use strict';
  app.ctrl('mainCtrl', ["$scope","$rootScope","publicVal","queryClassify","$timeout","soilDemand","njwAlert","getNews",
    function ($scope,$rootScope,publicVal,queryClassify,$timeout,soilDemand,njwAlert,getNews) {
          ...
          landNews.push({
            list: (function () {
              ...
              angular.forEach(res.cqlz, function (_d,i) {
                if(i!==0){
                  list.push({title: _d.infoTitle, date: _d.updateDate,url:'http://www.nongj.com/info/infoContent?id='+_d.infoId});
                }
